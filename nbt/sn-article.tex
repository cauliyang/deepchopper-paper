...
\abstract{
	...
	This study explores the application of \glspl{llm} to nanopore direct RNA sequencing data, focusing on predicting adapters.
...
%References:
%Doitsidis, A., et al. (2018). Pore-caster: A deep neural network for accurate base calling in nanopore sequencing. BMC Genomics, 19(1), 1-13.
%Kondrashov, A., et al. (2018). Improving nanopore RNA sequencing accuracy with deep learning. Nature Communications, 9(1), 1-11.
%Ragan, M. A., et al. (2017). A deep learning framework for RNA structure prediction. Nature Methods, 14(8), 615-621.
%Finn, C., et al. (2016). Deep learning for protein structure prediction. Science, 354(6312), 341-344.
%Al-Rfou, D., et al. (2020). Longformer: The long-document transformer. arXiv preprint arXiv:2006.16633.
%Vaswani, A., et al. (2017). Attention is all you need. Advances in Neural Information Processing Systems, 30(1), 6000-6010.
%Devlin, J., Chang, M. W., Lee, K., & Toutanova, K. (2018). BERT: Pre-training of deep bidirectional transformers for language understanding. Proceedings of the 51st Annual Meeting of the Association for Computational Linguistics, 4171-4186.
%Radford, A., et al. (2019). Language models are few-shot learners. Advances in Neural Information Processing Systems, 32(1), 2167-2177.
%Brown, J. L., et al. (2020). Language models are 0-shot learners. Proceedings of the 58th Annual Meeting of the Association for Computational Linguistics, 6414-6423.
