...
\begin{tikzpicture}[
	...
	% Exitron and Exon
	\begin{scope}[local bounding box=exon, scale=1, transform shape]
	...
	\begin{scope}[shift={(tokens1)}, yshift=-1.2cm, xshift=-1.5cm,
		edge1/.style={black, line width=0.6pt, -{Stealth[length=3pt, width=2pt]}, shorten >=0.5pt, shorten <=0.5pt},
		local bounding box=lcglm, scale=0.5, transform shape]
		\graph [
			grow right = 1cm,
			edges = {edge1},
	...
	edge[blue,  skip loop={20mm}{Loss}] (rnaseq-1-12);

	\draw [connect] (tokens1.south) |- ++(-5em, -0.1em) |-  ($(input) + (0.1em, 0)$);

	\draw [connect] ($(b3.east) + (1pt, 0)$) -| ++ (0.5em, -1.45em)  -|   ($(features1) + (-0.3em, 0.3em)$);
