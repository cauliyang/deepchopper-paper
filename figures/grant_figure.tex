...
\begin{tikzpicture}[
	...
	\begin{scope}[shift={(exon.center)}, yshift=-1.3cm, xshift=9,  start chain=1 going below, node distance=0mm, scale=0.75, transform shape]
	...
	\begin{scope}[shift={(lcglm)}, yshift=-0.6cm, x=2.2cm, y=1.4cm, local bounding box=mlp,
			mynode/.style={thick, draw=c7,fill=c7!20, circle, minimum size=15},
            rotate=-90,
            scale=0.3,
            transform shape,
		]
