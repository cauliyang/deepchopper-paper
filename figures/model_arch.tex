...
\begin{tikzpicture}[
	...
	\draw [connect]  ($(rnaseq-1-1) + (-25pt, 0)$) -| ($(qblock) + (-52pt, 0)$) -- (qblock);

	\node (qualnode1) [left=20pt of modeloutline, rotate=270] {
	...
	\draw [connect]  ($(outputbox.east)$)  -| node [pos=0.75, fill=white, inner sep=1pt, rotate=270]{Loss} ($(intputoutline.east) + (4pt, -70pt)$) -- ++(-15pt, 0);
	% } 
\end{tikzpicture}
