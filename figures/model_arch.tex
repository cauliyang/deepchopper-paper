...
\begin{tikzpicture}[
	...
	model box/.style={rectangle, draw=black!40, thick, rounded corners, inner sep=5pt, fill=c1, minimum width=7cm},
	input box/.style={fill=c1, draw=black!40,  thick, rounded corners, inner sep=5pt, minimum width=7cm},
	...
	\begin{scope}[shift={(smoutputbox.south)}, yshift=-\boxdist, local bounding box=predictbox]
		\matrix (predictseq) [matrix of nodes, nodes in empty cells,
			column sep=-\pgflinewidth, row sep=2pt,
	...
	\draw [connect]  ($(rnaseq-1-1) + (-25pt, 0)$) -| node [pos=0.75, fill=white, inner sep=5pt, rotate=270]{Qual} ($(qblock) + (-62pt, 0)$) -- (qblock);

	% \node (qualnode1) [left=50pt of modeloutline, rotate=270] {
	...
	% 		row 1 column 4/.style={nodes={fill=q5}},
	% 		row 1 column 5/.style={nodes={fill=q4}},
	% 		row 1 column 6/.style={nodes={fill=q3}},
	% 		row 1 column 7/.style={nodes={fill=q3}},
	% 		row 1 column 8/.style={nodes={fill=q3}},
	% 		row 1 column 9/.style={nodes={fill=q3}},
	% 		row 1 column 10/.style={nodes={fill=q3}},
	% 		row 1 column 11/.style={nodes={fill=q4}},
	% 		row 1 column 12/.style={nodes={fill=q5}},
	% 		row 1 column 13/.style={nodes={fill=q6}},
	% 		row 1 column 14/.style={nodes={fill=q7}},
	% 		row 1 column 15/.style={nodes={fill=q8}},
	% 	] {
	% 		 &  &  &  &  &  &  &  &  &  &  &  &  &  & \\
	% 	};
	% };
	...
	\draw [connect]  ($(outputbox.east)$)  -| node [pos=0.75, fill=white, inner sep=5pt, rotate=270]{Loss} ($(intputoutline.east) + (10pt, -70pt)$) -- ++(-15pt, 0);
	% } 
\end{tikzpicture}
