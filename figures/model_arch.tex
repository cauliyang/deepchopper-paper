...
\begin{tikzpicture}[
	font=\small, block/.style = {rectangle, draw, text centered, rounded corners, minimum height=4em, minimum width=4em}, qual block/.style = {rectangle, fill=q4, text centered, rounded corners, minimum height=4em, minimum width=4em}, connect/.style={rounded corners, black!40, text=black, line width=1.5pt, -{Stealth[length=5pt, width=4pt]}, shorten >=1pt, shorten <=1pt},
    model box/.style={rectangle, draw=black!40, thick, rounded corners, inner sep=10pt, inner ysep=5pt, fill=c1},
	input box/.style={fill=c1, draw=black!40,  thick, rounded corners, inner sep=5pt},
	output box/.style={fill=c1, draw=black!40, thick, rounded corners, inner sep=5pt, minimum height=12em},
	token node/.style={ draw=black, line width=0.5pt, minimum size=1.2em},
	]
	\def\boxdist{1cm}

	\begin{scope}[local bounding box=nanoporebox]
		\node (nanoporenode) [block, rotate=270, minimum size=10em] {Nanopore};
	\end{scope}
	...
	\begin{scope}[shift={(tokenbox.east)}, xshift=\boxdist, yshift=-0.45cm,
	...
	\begin{scope}[shift={(featuresbox.east)}, xshift=\boxdist  * 1.5, yshift=-0.1cm, local bounding box=qualblockbox,
        ...
        resuidual block/.style = {rectangle, fill=q4, text centered, rounded corners, minimum height=4em, minimum width=4em},
        seq block/.style = {rectangle, fill=q5, text centered, rounded corners, minimum height=1em, minimum width=4em},
        ]
	...
	% predict
	\begin{scope}[shift={(smoutputbox.east)}, xshift=\boxdist * 1.5, local bounding box=predictbox]
		\node (predictseqnode)[
			rotate=270,
		] {
