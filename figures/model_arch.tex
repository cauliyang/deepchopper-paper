...
\begin{tikzpicture}[
    ...
    model box/.style={rectangle, draw=black!40, thick, rounded corners, inner sep=10pt, inner ysep=3pt, fill=c1},
	input box/.style={fill=c1, draw=black!40,  thick, rounded corners, inner sep=5pt},
	...
	\begin{scope}[shift={(nanoporebox.east)}, xshift=\boxdist * 1.5, local bounding box=inputbox]
		\node (rnaseqnode) [
			...
			\tikz \matrix (rnaseq) [matrix of nodes, nodes in empty cells,
				column sep=-\pgflinewidth * 3, row sep=3pt,
				nodes={thin, inner sep=1pt,  minimum size=0.8em, anchor=center},
				row 3/.style={nodes={fill=p1}},
	...
	\begin{scope}[on background layer]
		...
		\node (modeloutline) [fit=(tokenbox)(lcgmlbox)(qualblockbox)(mlpbox)(outputbox), model box] {};
		\node[inner sep=5pt, anchor=north west] at (modeloutline.north west) {Model};
