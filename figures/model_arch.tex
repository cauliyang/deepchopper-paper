...
\begin{tikzpicture}[
	...
	% mlp
	\begin{scope}[shift={(qualbox.east)}, xshift=\boxdist, yshift=-\boxdist * 1.5,
	...
	\begin{scope}[on background layer]
		\node (modeloutline) [fit=(tokenbox)(lcgmlbox)(qualblockbox)(qualbox)(qualbox)(mlpbox)(outputbox), rectangle, fill=c1] {};
		\node[inner sep=2pt, anchor=south east] at (modeloutline.south east) {Model};
	\end{scope}
