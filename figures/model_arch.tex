...
\begin{tikzpicture}[
    ...
    \draw [connect]  ($(intputoutline.south) + (30pt, 10pt)$) -- ++(0, -12pt)  -| ($(qblock) + (0, -14pt)$);

    \draw [connect]  ($(outputbox.north) + (0, 1pt)$) --  ++(0, 28pt)  -|  node [pos=0.25, fill=white, inner sep=0]{Loss} ($(intputoutline.north) + (20pt, -10pt)$);
