...
\begin{figure}[!ht]
	...
	\caption{{\bf \hl{Performance evaluation in a held-out test dataset showing Recall, Precision, and F1 values for DeepChopper, Pychopper, Porechop, and Porechop\_ABI.}}}\label{fig:sf1}
\end{figure}
