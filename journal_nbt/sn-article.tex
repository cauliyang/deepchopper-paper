...
\yy{may need to change; refered to tingyou}
...
The visualization of gene fusion events was performed using chimeraviz (1.30.0)~\cite{laagstad2017chimeraviz}, a R package designed for the analysis and visualization of gene fusion. 
...
Raw and processed data from this study are deposited in the Gene Expression Omnibus (GEO) database under accession code GSE277934 (\url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE277934}).
The dataset include VCaP 002, and VCaP 004.
This dataset includes nanopore \gls{drs} data with adapters trimmed by both Dorado and DeepChopper, as well as nanopore cDNA data.
Processed BAM files are also available.
The human reference genome (GRCh38) used in this study was obtained from \url{http://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/reference/GRCh38_reference_genome}.

\bmhead{Code Availability}

DeepChopper (v1.2.5), implemented in Rust and Python, is open-source and available on GitHub (\url{https://github.com/ylab-hi/DeepChopper}) under the Apache License, Version 2.0.
...
The GitHub repository includes comprehensive documentation, usage examples, and scripts for model training, performance assessment, and data simulation.
