...
Finally, we evaluated whether chimera artifact correction by DeepChopper could improve gene fusion detection. We applied FusionSeeker for gene fusion detection from VCaP \gls{drs} and direct cDNA sequencing long-reads. We observed that DeepChopper processed long-reads result in a 89\% reduction of gene fusion calls compared to Dorado adapter-trimmed long-reads, and none of these re
