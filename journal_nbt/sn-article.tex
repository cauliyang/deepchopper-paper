...
To verify these identified reads, we cross-referenced them with data from other sequencing platforms, including ONT \gls{pcr} cDNA, ONT CapTrap, ONT R2C2, PacBio (PB) cDNA, and PB CapTrap. Additionally, we calculated the supporting rates to assess the consistency of chimeric read detection across these platforms.
