...
Biologically, human protein-coding transcripts have a median length of approximately 2.7 kb (95th percentile: $\sim8.7$ kb, 99th percentile: $\sim14$ kb), with over 99.97\% of transcripts falling below 32 kb based on current annotations (\mbox{\edfigref{fig:transcript_len}{}}).
...
Porechop/Porechop\_ABI require exact matching or stable k-mer patterns\mbox{~\cite{Wick2017,bonenfant2023porechop}}---incompatible with unknown, corrupted adapters mis-called by RNA basecallers.
