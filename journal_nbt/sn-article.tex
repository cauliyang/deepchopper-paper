...
Using a MinION sequencer with four R9.4 flow cells, we generated a total of 9,177,639 long reads in FASTQ format, with base-calling performed by \gls{ont}'s Dorado software (\url{https://github.com/nanoporetech/dorado}, v0.5.2).
...
Next, we evaluated whether DeepChopper could improve gene fusion detection by chimera artifact correction.
Gene fusion calls detected by FusionSeeker~\cite{chen2023gene} from DeepChopper-processed \gls{drs} reads showed a 89\% reduction compared to those from adapter-trimmed \gls{drs} reads processed by Dorado.
...
Additionally, ribosomal protein genes were also enriched in chimera artifacts associated with RNA004 \gls{drs} chemistry (\edfigref{fig:sf3}{b}).
...
Additional cDNA-based long-read sequencing data from the WTC11 cell line were used for further validation, incorporating five distinct platforms: \gls{ont} \gls{pcr}-cDNA, \gls{ont} CapTrap, \gls{ont} R2C2, \gls{pb} cDNA, and \gls{pb} CapTrap-seq.
...
\begin{thebibliography}{10}
	...
	\newblock \bibinfo{title}{Highly parallel direct rna sequencing on an array of nanopores}.
	\newblock \emph{\bibinfo{journal}{Nature methods}} \textbf{\bibinfo{volume}{15}}, \bibinfo{pages}{201--206} (\bibinfo{year}{2018}).

	\bibitem{jain2022advances}
	\bibinfo{author}{Jain, M.}, \bibinfo{author}{Abu-Shumays, R.}, \bibinfo{author}{Olsen, H.~E.} \& \bibinfo{author}{Akeson, M.}
	\newblock \bibinfo{title}{Advances in nanopore direct rna sequencing}.
	\newblock \emph{\bibinfo{journal}{Nature methods}} \textbf{\bibinfo{volume}{19}}, \bibinfo{pages}{1160--1164} (\bibinfo{year}{2022}).

	\bibitem{smith2020molecular}
	\bibinfo{author}{Smith, M.~A.} \emph{et~al.}
	\newblock \bibinfo{title}{Molecular barcoding of native rnas using nanopore sequencing and deep learning}.
	\newblock \emph{\bibinfo{journal}{Genome research}} \textbf{\bibinfo{volume}{30}}, \bibinfo{pages}{1345--1353} (\bibinfo{year}{2020}).

	\bibitem{liu2024sequencing}
	\bibinfo{author}{Liu-Wei, W.} \emph{et~al.}
	\newblock \bibinfo{title}{Sequencing accuracy and systematic errors of nanopore direct rna sequencing}.
	\newblock \emph{\bibinfo{journal}{BMC genomics}} \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{528} (\bibinfo{year}{2024}).

	\bibitem{benegas2024genomic}
	\bibinfo{author}{Benegas, G.}, \bibinfo{author}{Ye, C.}, \bibinfo{author}{Albors, C.}, \bibinfo{author}{Li, J.~C.} \& \bibinfo{author}{Song, Y.~S.}
	\newblock \bibinfo{title}{Genomic language models: Opportunities and challenges} (\bibinfo{year}{2024}).
	...
	\newblock \bibinfo{title}{Hyenadna: Long-range genomic sequence modeling at single nucleotide resolution}.
	\newblock \emph{\bibinfo{journal}{Advances in neural information processing systems}} \textbf{\bibinfo{volume}{36}} (\bibinfo{year}{2024}).

	\bibitem{poli2023hyena}
	\bibinfo{author}{Poli, M.} \emph{et~al.}
	\newblock \bibinfo{title}{Hyena hierarchy: Towards larger convolutional language models}.
	\newblock \eprint{2302.10866}.

	\bibitem{he2016deep}
	\bibinfo{author}{He, K.}, \bibinfo{author}{Zhang, X.}, \bibinfo{author}{Ren, S.} \& \bibinfo{author}{Sun, J.}
	\newblock \emph{\bibinfo{title}{Deep residual learning for image recognition}}, \bibinfo{pages}{770--778} (\bibinfo{year}{2016}).

	\bibitem{zhou2023dnabert2}
	\bibinfo{author}{Zhou, Z.} \emph{et~al.}
	\newblock \bibinfo{title}{{{DNABERT-2}}: Efficient foundation model and benchmark for multi-species genome}.
	\newblock \eprint{2306.15006}.

	\bibitem{dalla2023nucleotide}
	\bibinfo{author}{Dalla-Torre, H.} \emph{et~al.}
	\newblock \bibinfo{title}{The nucleotide transformer: Building and evaluating robust foundation models for human genomics}.
	\newblock \emph{\bibinfo{journal}{BioRxiv}} \bibinfo{pages}{2023--01} (\bibinfo{year}{2023}).

	\bibitem{nguyen2024sequence}
	\bibinfo{author}{Nguyen, E.} \emph{et~al.}
	\newblock \bibinfo{title}{Sequence modeling and design from molecular to genome scale with evo}.
	\newblock \emph{\bibinfo{journal}{bioRxiv}}  (\bibinfo{year}{2024}).
	\newblock \urlprefix\url{https://www.biorxiv.org/content/early/2024/02/27/2024.02.27.582234}.

	\bibitem{chen2021systematic}
	\bibinfo{author}{Chen, Y.} \emph{et~al.}
	\newblock \bibinfo{title}{A systematic benchmark of nanopore long read rna sequencing for transcript level analysis in human cell lines}.
	\newblock \emph{\bibinfo{journal}{BioRxiv}} \bibinfo{pages}{2021--04} (\bibinfo{year}{2021}).

	\bibitem{nano2017tech}
	\bibinfo{title}{{Chemistry Technical Document (CHTD{$\_$}500{$\_$}v1{$\_$}revAQ{$\_ $}07Jul2016)}} (\bibinfo{year}{2017}).
	\newblock \urlprefix\url{https://nanoporetech.com/document/chemistry-technical-document}.

	\bibitem{li2018minimap2}
	\bibinfo{author}{Li, H.}
	\newblock \bibinfo{title}{Minimap2: pairwise alignment for nucleotide sequences}.
	\newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{34}}, \bibinfo{pages}{3094--3100} (\bibinfo{year}{2018}).

	\bibitem{kent2002blat}
	\bibinfo{author}{Kent, W.~J.}
	\newblock \bibinfo{title}{Blat—the blast-like alignment tool}.
	\newblock \emph{\bibinfo{journal}{Genome research}} \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{656--664} (\bibinfo{year}{2002}).

	\bibitem{pardo2024systematic}
	\bibinfo{author}{Pardo-Palacios, F.~J.} \emph{et~al.}
	\newblock \bibinfo{title}{Systematic assessment of long-read rna-seq methods for transcript identification and quantification}.
	\newblock \emph{\bibinfo{journal}{Nature methods}} \bibinfo{pages}{1--15} (\bibinfo{year}{2024}).

	\bibitem{prjibelski2023accurate}
	\bibinfo{author}{Prjibelski, A.~D.} \emph{et~al.}
	\newblock \bibinfo{title}{Accurate isoform discovery with isoquant using long reads}.
	\newblock \emph{\bibinfo{journal}{Nature Biotechnology}} \textbf{\bibinfo{volume}{41}}, \bibinfo{pages}{915--918} (\bibinfo{year}{2023}).

	\bibitem{chen2023gene}
	\bibinfo{author}{Chen, Y.} \emph{et~al.}
	\newblock \bibinfo{title}{Gene fusion detection and characterization in long-read cancer transcriptome sequencing data with fusionseeker}.
	\newblock \emph{\bibinfo{journal}{Cancer research}} \textbf{\bibinfo{volume}{83}}, \bibinfo{pages}{28--33} (\bibinfo{year}{2023}).

	\bibitem{uhrig2021accurate}
	\bibinfo{author}{Uhrig, S.} \emph{et~al.}
	\newblock \bibinfo{title}{Accurate and efficient detection of gene fusions from rna sequencing data}.
	\newblock \emph{\bibinfo{journal}{Genome research}} \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{448--460} (\bibinfo{year}{2021}).

	\bibitem{li2009sequence}
	\bibinfo{author}{Li, H.} \emph{et~al.}
	\newblock \bibinfo{title}{The sequence alignment/map format and samtools}.
	\newblock \emph{\bibinfo{journal}{bioinformatics}} \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{2078--2079} (\bibinfo{year}{2009}).
	...
	\bibinfo{author}{Yadan, O.}
	\newblock \bibinfo{title}{Hydra - a framework for elegantly configuring complex applications}.
	\newblock \bibinfo{howpublished}{Github} (\bibinfo{year}{2019}).
	\newblock \urlprefix\url{https://github.com/facebookresearch/hydra}.

	\bibitem{li2024pxblat}
	\bibinfo{author}{Li, Y.} \& \bibinfo{author}{Yang, R.}
	\newblock \bibinfo{title}{{PxBLAT: an efficient python binding library for BLAT}}.
	\newblock \emph{\bibinfo{journal}{BMC Bioinf.}} \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{1--8} (\bibinfo{year}{2024}).

	\bibitem{martin2011cutadapt}
	\bibinfo{author}{Martin, M.}
	\newblock \bibinfo{title}{Cutadapt removes adapter sequences from high-throughput sequencing reads}.
	\newblock \emph{\bibinfo{journal}{EMBnet. journal}} \textbf{\bibinfo{volume}{17}}, \bibinfo{pages}{10--12} (\bibinfo{year}{2011}).

	\bibitem{grunberger2022nanopore}
	\bibinfo{author}{Gr{\"u}nberger, F.}, \bibinfo{author}{Ferreira-Cerca, S.} \& \bibinfo{author}{Grohmann, D.}
	\newblock \bibinfo{title}{Nanopore sequencing of rna and cdna molecules in escherichia coli}.
	\newblock \emph{\bibinfo{journal}{Rna}} \textbf{\bibinfo{volume}{28}}, \bibinfo{pages}{400--417} (\bibinfo{year}{2022}).

	\bibitem{tardaguila2018sqanti}
	\bibinfo{author}{Tardaguila, M.} \emph{et~al.}
	\newblock \bibinfo{title}{Sqanti: extensive characterization of long-read transcript sequences for quality control in full-length transcriptome identification and quantification}.
	\newblock \emph{\bibinfo{journal}{Genome research}} \textbf{\bibinfo{volume}{28}}, \bibinfo{pages}{396--411} (\bibinfo{year}{2018}).

	\bibitem{barretina2012cancer}
	\bibinfo{author}{Barretina, J.} \emph{et~al.}
	\newblock \bibinfo{title}{The cancer cell line encyclopedia enables predictive modelling of anticancer drug sensitivity}.
	\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{483}}, \bibinfo{pages}{603--607} (\bibinfo{year}{2012}).

	\bibitem{dobin2013star}
	\bibinfo{author}{Dobin, A.} \emph{et~al.}
	\newblock \bibinfo{title}{Star: ultrafast universal rna-seq aligner}.
	\newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{29}}, \bibinfo{pages}{15--21} (\bibinfo{year}{2013}).

	\bibitem{hu2015gsds}
	\bibinfo{author}{Hu, B.} \emph{et~al.}
	\newblock \bibinfo{title}{Gsds 2.0: an upgraded gene feature visualization server}.
	\newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{1296--1297} (\bibinfo{year}{2015}).

	\bibitem{samarakoon2024interactive}
	\bibinfo{author}{Samarakoon, H.} \emph{et~al.}
	\newblock \bibinfo{title}{Interactive visualisation of raw nanopore signal data with squigualiser}.
	\newblock \emph{\bibinfo{journal}{Biorxiv}} \bibinfo{pages}{2024--02} (\bibinfo{year}{2024}).
	...
	\newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{33}}, \bibinfo{pages}{2954--2956} (\bibinfo{year}{2017}).

	\bibitem{sherman2022david}
	\bibinfo{author}{Sherman, B.~T.} \emph{et~al.}
	\newblock \bibinfo{title}{David: a web server for functional enrichment analysis and functional annotation of gene lists (2021 update)}.
	\newblock \emph{\bibinfo{journal}{Nucleic acids research}} \textbf{\bibinfo{volume}{50}}, \bibinfo{pages}{W216--W221} (\bibinfo{year}{2022}).
