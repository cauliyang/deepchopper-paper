...
\newcommand{\edfigref}[2]{Extended Data Fig.~\hyperref{#1}{\ref*{#1}{#1}}}
...
Among these technologies, Oxford \gls{drs} stands out as a powerful tool for sequencing full-length RNA molecules with the unique advantage of preserving native RNA modifications~\cite{jain2022advances}.
