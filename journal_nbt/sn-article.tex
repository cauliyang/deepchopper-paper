...
Long-range token interactions is still changing in tansformer-based language model,
...
For basecalling, we used Dorado (v0.7.1) for both datasets.
...
After basecalling, we removed short reads (<50 bases) using SeqKit (v2.4.0).
